...
function enableTabScroll(div, tabContent) {
    ...
    var num = $("form .price a").index($(this));
    var color;
    switch (num) {
      case 0:
        $("textarea.textarea").css("border", "1px solid #000");
        break;
      case 1:
        $("textarea.textarea").css("border", "1px solid #8fc31f");
        break;
      case 2:
        $("textarea.textarea").css("border", "1px solid #ffc31f");
        break;
      case 3:
    ...
    if (color) {
      $("textarea.textarea").css("border", "1px solid " + color);
    }
}
...
function twoInput(){
    ...
    var price = parseFloat($("i.total-price").text());
    $(".input2").val(price);
}
