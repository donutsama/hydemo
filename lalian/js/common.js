...
var countdown=function()
{
	...
	this.promotional = document.getElementById("bun_promotional");
	this.a_href = '';
	this.img_src = '';
    this.productShowUrl =  $(".product_show_url");
    this.productActivityUrl =  $(".product_activity_url");
	this.add=function(id,a_href,img_src,proId,proNum)
	{
		this.a_href = a_href;
	...
	this.work=function(id,type)
	{
        ...
        var o = document.getElementById("promotiona");
		var e = document.getElementById("cd_"+type+"_"+id);
		var value=parseInt(e.innerHTML);
		if( (value == 0 && _self.work( id,_self.parent[type] )==false) ||value<0)
		{
			if (this.a_href != false) {
				var a_href_obj = _self.promotional.getElementsByTagName("a");
				a_href_obj[0].href = _self.a_href;
				var img_src_obj = _self.promotional.getElementsByTagName("img");
				img_src_obj[0].src = _self.img_src;
                             //   var partten = /[\/id\/][\d]{1,}/ig;
                             //   var proId =partten.exec(_self.a_href);
                                var proId = this.proId;
                                var proNum = this.proNum;
                                _self.productShowUrl.each(function(){
                                    this.href = '/site/products/id/'+proId+'/type/cu';
                                });
                                _self.productActivityUrl.each(function(){
                                    this.href = '/active/activity/id/'+proId+'/type/cu';
                                });
                                if(proNum == 0){
                                    o.innerHTML = '&nbsp;&nbsp;&nbsp;&nbsp;抢购已结束';
                                }else{
